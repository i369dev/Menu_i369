...
export const Sidebar: React.FC<SidebarProps> = ({ tabs, activeTab, setActiveTab, onExit, onLogout }) => {
    return (
        <aside className="w-full md:w-72 bg-white border-r border-gray-200 flex-shrink-0 flex flex-col h-auto md:h-screen z-10 shadow-lg">
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50 space-y-3">
                ...
                <button onClick={onLogout} className="w-full text-left px-4 py-2 text-xs font-bold text-red-600 hover:text-red-700 uppercase tracking-wider">
                    Log Out
                </button>
            </div>
        </aside>
